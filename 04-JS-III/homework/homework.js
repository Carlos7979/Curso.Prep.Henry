...
function agregarNumeros(numeros) {
  ...
  // Tu código:
  return numeros.reduce( (acc, act) => acc + act);
}
...
function todosIguales(arreglo) {
  ...
  //Escribe tu código aquí  
  return arreglo.every((element, index, array) => element === array[0]);
} 
...
function mesesDelAño(array) {
  ...
  // Tu código:
  const newArray = array.filter(month => (month === 'Enero' || month === 'Marzo' || month === 'Noviembre'));
